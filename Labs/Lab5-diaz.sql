...
from sales.orders o1
	inner join 
	(select e.empid, max(e.orderdate) as maxorderdate from 
	sales.orders e group by e.empid) as o2
...
select o.orderid, o.orderdate, o.custid, o.empid, o.rownum
from mt o where  o.rownum between 11 and 20;
...
drop view if exists dbo.ramon;
go
create view dbo.ramon as
...
go
select * from dbo.ramon order by empid, orderyear;
go
...
select * from dbo.ramon order by empid, orderyear;
select r.empid, r.orderyear, r.qty,
(select sum(r1.qty) as runqty from dbo.ramon r1 where r.empid = r1.empid
and r1.orderyear <= r.orderyear) as runqty
	from ramon r
	order by r.empid, r.orderyear;
